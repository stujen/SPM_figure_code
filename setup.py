...
setup(
    name="SPM figure 1 production code",
    version="v0.0.0",
    description="Code to produce different versions of SR1.5 SPM figure 1.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/stujen/SPM_figure_code",
    classifiers=[
        #   3 - Alpha
        #   4 - Beta
        #   5 - Production/Stable
    ...
    install_requires=["numpy", "scipy", "pandas", "statsmodels", "matplotlib"],
